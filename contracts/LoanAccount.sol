...
contract LoanAccount is Ownable, IERC721Receiver {
    ...
    function calculate_emi() public view returns (uint256) {
        ...
        uint256 _numerator = (10000 + uint256(_interest_rate / _no_of_payments)) ** _no_of_payments;
        uint256 _denominator = ((10000 + uint256(_interest_rate / _no_of_payments)) ** _no_of_payments) - (10000 ** _no_of_payments);
        uint256 _emi = (_disbursed_token_asset._disbursed_amount * uint256(_interest_rate / _no_of_payments) * _numerator) / _denominator; 
